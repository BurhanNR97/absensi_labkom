...
public class adapterRekapAbsen extends RecyclerView.Adapter {

    private List<modelRekapAbsen> dataList;

    public adapterRekapAbsen(List<modelRekapAbsen> dataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.tabel_absen, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (rowPos == 0) {
            ...
            modelRekapAbsen data = dataList.get(rowPos - 1);
    ...
    public class RowViewHolder extends RecyclerView.ViewHolder {
        ...
        RowViewHolder(View itemView) {
            super(itemView);
            txtNo = itemView.findViewById(R.id.tb_absenNo);
            txtNim = itemView.findViewById(R.id.tb_absenNIM);
            txtNama = itemView.findViewById(R.id.tb_absenNama);
            txtKet = itemView.findViewById(R.id.tb_absenKet);
        }
    }
}