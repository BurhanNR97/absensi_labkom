...
public class RekapAbsen extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_rekapabsen);
        ...
        list = new ArrayList<>();
        layout = findViewById(R.id.rvRekapAbsen);
        teks = findViewById(R.id.kosongRekapAbsen);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(RekapAbsen.this, MainAdmin.class));
        finish();
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Intent intent = new Intent(RekapAbsen.this, detailAbsensi.class);
