...
public class KonfirMhs extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_konfir_mhs);
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_konfirAbseni);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Verifikasi Absensi");

        db = FirebaseDatabase.getInstance().getReference("kelas").child(getIntent().getStringExtra("id"));

        adapter = new adpSlipawal(this);
        layout = findViewById(R.id.rvAbsen);
        teks = findViewById(R.id.kosongAbsen);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(KonfirMhs.this, MainDosen.class);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Intent intent = new Intent(KonfirMhs.this, absen.class);
        intent.putExtra("id", getIntent().getStringExtra("id"));
