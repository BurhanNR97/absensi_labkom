...
import com.absensi.labkom.adapter.adpKuliahku;
...
public class Kuliahku extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ArrayList<modelKuliah> list;
    ListView layout;
    TextView teks;
    adpKuliahku adp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuliahku);
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_kuliah);
        ...
        list = new ArrayList<>();
        teks = findViewById(R.id.kosongKuliahku);
        layout = findViewById(R.id.rvKuliahku);
        adp = new adpKuliahku(this);
    ...
    protected void onResume() {
        ...
        DatabaseReference db = FirebaseDatabase.getInstance().getReference("kuliahku").child(nim);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        TextView getId = (TextView)view.findViewById(R.id.listKuliahkuKode);
        ...
        db.child(nim).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (ket.equals("Belum bayar") || ket.equals("Ditolak")) {
                    Toast pesan = Toast.makeText(Kuliahku.this, "Silahkan lakukan pembayaran", Toast.LENGTH_SHORT);
                    pesan.setGravity(Gravity.CENTER_VERTICAL, 0, 0);
                    pesan.show();
                } else
                if (ket.equals("Lunas")) {
                    Intent intent = new Intent(Kuliahku.this, scanQR.class);
    ...
    public void onBackPressed() {
            Intent intent = new Intent(Kuliahku.this, MainActivity.class);
            intent.putExtra("id", getIntent().getStringExtra("id"));
            intent.putExtra("nama", getIntent().getStringExtra("nama"));
            intent.putExtra("no", getIntent().getStringExtra("no"));
            startActivity(intent);
